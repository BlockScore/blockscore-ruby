...
RSpec.shared_context 'a resource' do
  ...
  it 'test_list_resource' do
    described_class.all

    assert_requested(@api_stub, times: 1)
  end

  it 'test_list_resource_with_count' do
  ...
  it 'test_list_resource_with_count_and_offset' do
